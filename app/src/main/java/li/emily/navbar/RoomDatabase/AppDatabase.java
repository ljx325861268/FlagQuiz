package li.emily.navbar.RoomDatabase;
...
import li.emily.navbar.Model.CountryDAO;
 ...
 *
 */
@Database(entities = {CountryRow.class}, version = 1)  // Replace "Book.class" with whatever your Book entity class is.
public abstract class AppDatabase extends RoomDatabase {
    public abstract CountryDAO countryDao();          // Replace BookDao with whatever you name your DAO
